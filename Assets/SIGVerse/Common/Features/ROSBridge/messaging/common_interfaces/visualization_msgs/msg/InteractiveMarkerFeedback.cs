	...
	namespace visualization_msgs 
	{
		namespace msg 
		{
			...
			public class InteractiveMarkerFeedback : RosMessage
			{
				...
				public InteractiveMarkerFeedback(std_msgs.msg.Header header, string client_id, string marker_name, string control_name, byte event_type, geometry_msgs.msg.Pose pose, System.UInt32 menu_entry_id, UnityEngine.Vector3 mouse_point, bool mouse_point_valid)
				{
					this.header = header;
