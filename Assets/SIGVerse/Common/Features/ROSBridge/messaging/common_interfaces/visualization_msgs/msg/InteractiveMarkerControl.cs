	...
	namespace visualization_msgs 
	{
		namespace msg 
		{
			...
			public class InteractiveMarkerControl : RosMessage
			{
				...
				public InteractiveMarkerControl(string name, UnityEngine.Quaternion orientation, byte orientation_mode, byte interaction_mode, bool always_visible, System.Collections.Generic.List<visualization_msgs.msg.Marker>  markers, bool independent_marker_orientation, string description)
				{
					this.name = name;
