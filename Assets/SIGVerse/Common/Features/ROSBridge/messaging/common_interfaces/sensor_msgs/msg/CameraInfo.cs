	...
	namespace sensor_msgs 
	{
		namespace msg 
		{
			...
			public class CameraInfo : RosMessage
			{
				...
				public CameraInfo(std_msgs.msg.Header header, System.UInt32 height, System.UInt32 width, string distortion_model, System.Collections.Generic.List<double>  d, double[]  k, double[]  r, double[]  p, System.UInt32 binning_x, System.UInt32 binning_y, sensor_msgs.msg.RegionOfInterest roi)
				{
					this.header = header;
					this.height = height;
					this.width = width;
