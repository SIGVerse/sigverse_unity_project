	...
	namespace sensor_msgs 
	{
		namespace msg 
		{
			...
			public class LaserScan : RosMessage
			{
				...
				public LaserScan(std_msgs.msg.Header header, float angle_min, float angle_max, float angle_increment, float time_increment, float scan_time, float range_min, float range_max, System.Collections.Generic.List<float>  ranges, System.Collections.Generic.List<float>  intensities)
				{
					this.header = header;
