...
{
	public class EthanSimpleHandController : MonoBehaviour
	{
#if SIGVERSE_STEAMVR
		...
		void Awake()
		{
			string typeStr = (this.inputSource==SteamVR_Input_Sources.LeftHand)? "Left" : "Right";
		...
		void Start()
		{
			...
			float xySign = (this.inputSource==SteamVR_Input_Sources.LeftHand)? 1.0f : -1.0f;
